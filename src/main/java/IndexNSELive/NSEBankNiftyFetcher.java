...
public class NSEBankNiftyFetcher {
    ...
    public Map<String,Map<String, String>> getMappedData() throws IOException, ParseException {
        Document doc;
        doc = Jsoup.connect("http://www.nseindia.com/live_market/dynaContent/live_watch/option_chain/optionKeys.jsp?symbolCode=-9999&symbol=BANKNIFTY&symbol=BANKNIFTY&instrument=OPTIDX&date=-&segmentLink=17&segmentLink=17")
